...
// The registry is the "is this name a real model?" source for ambiguous
// effort-tail detection, so tests must seed it explicitly instead of
// inheriting whatever the process happens to hold.
