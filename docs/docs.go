...
const docTemplate = `{
    ...
    "paths": {
        "/channel/{id}/import_models_csv": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "UCloud CSV 文件(UTF-8)",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/dto.ImportCsvAPIResponse"
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.Verify2FARequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.Setup2FARequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/user/aff_transfer": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "转换的佣金额度数量",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.TransferAffQuotaRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.AmountRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/user/creem/pay": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "产品 ID 与支付方式",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.CreemPayRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/user/oauth/bindings/{provider_id}": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/user/setting": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "用户设置(预警类型/阈值/通知通道)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.UpdateUserSettingRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.StripePayRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "controller.StripePayRequest": {
            "type": "object",
            "properties": {
                "amount": {
                    "description": "Amount is the quantity of units to purchase.",
                    "type": "integer"
                },
                "cancel_url": {
                    "description": "CancelURL is the optional custom URL to redirect when payment is canceled.\nIf empty, defaults to the server's console topup page.",
                    "type": "string"
                },
                "payment_method": {
                    "description": "PaymentMethod specifies the payment method (e.g., \"stripe\").",
                    "type": "string"
                },
                "success_url": {
                    "description": "SuccessURL is the optional custom URL to redirect after successful payment.\nIf empty, defaults to the server's console log page.",
                    "type": "string"
                }
            }
        },
        "controller.TransferAffQuotaRequest": {
            "type": "object",
            "required": [
                "quota"
            ],
        ...
        "controller.UpdateUserSettingRequest": {
            "type": "object",
            "properties": {
