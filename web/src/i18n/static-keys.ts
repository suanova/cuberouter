...
export const STATIC_I18N_KEYS = [
  ...
  'Text rendering',
  'busy',
  // Native Media Studio: dynamic template, validation and workflow labels
  ...
  'Add an object',
  'Add or update text layer',
  'Advanced settings and text checking',
  'After editing',
  'Alignment',
  'All creations',
  'All templates',
  ...
  'Center',
  'Change appearance',
  'Check the prompt, reference images and numeric settings.',
  'Chibi animal sticker',
  'Choose a template or describe your first image.',
  ...
  'Continue editing',
  'Copy command',
  'Copy failed. Select and copy the command below.',
  'Correct text for this rectangle',
  'Cover color',
  'Cover old text with a solid background',
  ...
  'Describe the change to the selected area.',
  ...
  'Elapsed {{time}}',
  'Exact text expected in the image (optional)',
  'Example reference image',
  'Expires',
  'Faster preview · CFG 1',
  'Follow instruction',
  'Follow reference',
  'Four-panel story',
  ...
  'GPU generation',
  'Generate image',
  'Generate regional edit',
  'Generated image',
  'Generating {{count}} image…',
  'Generating…',
  ...
  'Image aspect ratio',
  'Image generated. Please review the requested text.',
  'Image generated. The automatic text check was unavailable.',
  'Image preview',
  ...
  'Images per batch',
  'Images per request',
  'Input command and output result',
  'Intended text (optional)',
  ...
  'Result',
  'Room or space',
  'Save text correction',
  'Seed',
  'Selected area instruction',
  ...
  'Template example',
  'Template gallery',
  'Text check is informational; generation is complete.',
  'Text color',
  'Text correction',
  'Text layer added. Select another rectangle to add more.',
  'Text layout',
  'Text preview only. Save to create a new version.',
  'Text to image',
